...
# Initialize session state for login if not present (Safety check)
...
with comm_tab_view:
    ...
    if not reports:
        ...
        for row in reports:
            ...
            author_tag=f"<br><span style='color:gray;font-size:0.8rem;font-style:italic;'>Reported by:{row['author']}</span>"
